...
\input{pages/safety&security.tex}

\section{Incidenti}
\input{pages/incidenti.tex}
\subsection{Morris Worm}
\input{pages/morrisworm.tex}
\subsection{Ariane 5}
\input{pages/ariane5.tex}
\subsection{Toyota}
\input{pages/toyota.tex}
...
\input{pages/approccirisolutivi.tex}
\subsection{Analisi Statica}
\input{pages/staticanalysis.tex}
\subsection{Sottoinsieme linguaggi} % MISRA
\input{pages/languagesubsets.tex}
\subsection{Rust}
\input{pages/rust.tex}
